...
const JobData = () => {
    ...
    console.log("in frontend job data",dataPosition)
    ...
    const filtereddataPosition = dataPosition.filter((pos) => {
    ...
    return (
        <Layout>
            <Breadcrumb pageName='Department Data' />
            <Link to="/job-data/add" >
                <ButtonOne  >
