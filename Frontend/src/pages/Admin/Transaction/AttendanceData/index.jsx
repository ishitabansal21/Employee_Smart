...
const AttendanceData = () => {
    ...
    return (
        <Layout>
            ...
            <div className='rounded-sm border border-stroke px-5 pt-2 pb-2.5 shadow-default dark:border-strokedark sm:px-7.5 xl:pb-10 mt-6'>
                    ...
                    <table className='w-full table-auto'>
                        ...
                        <tbody>
                            {filtereddataAttendance.slice(startIndex, endIndex).map((data, index) => {
                                console.log("attedance data",data);
                                return (
                                    <tr
                                        key={data.id}
                                    ...
                                    >
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <p className='text-black dark:text-white'>{data.employeeDepartment}</p>
                                        </td>
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                        ...
                                        <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <div className='flex items-center space-x-3.5'>
                                                <Link className='hover:text-black'
                                                    to={`/attendance-data/edit/${data.id}`}
                                                >
