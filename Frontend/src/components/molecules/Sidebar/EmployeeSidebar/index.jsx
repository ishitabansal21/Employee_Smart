...
import { FiClipboard, FiSettings,FiTwitter } from 'react-icons/fi';
          ...
          <div>
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              {/* <!-- Employee Salary Data --> */}
               ...
               {/* Social media */}
                ...
                <li>
                      ...
                      <NavLink
                        to='/community'
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/community' ||
              ...
              <li>
                    ...
                    <NavLink
                      to='/kanban'
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/kanban' ||
              ...
              {/* Kanban board ends */}
               ...
               <li>
                ...
                <NavLink
                  to='/groupchat'
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/groupchat' ||
