    ...
    useEffect(() => {
        const getDataEmployee = async () => {
            try {
                ...
                console.log("dataaaaaaaaaaa for img ",data);
                        ...
                        <div className="md:w-2/3 px-4 md:px-20 py-4 md:py-20">
                            <div className="w-full md:text-lg">
                                ...
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    ...
                                    <span className="inline-block w-7">:</span>{employeeData.join_date}
                                </h2>
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    <span className="inline-block w-32 md:w-40">Department</span>
                                    <span className="inline-block w-7">:</span>{employeeData.department}
